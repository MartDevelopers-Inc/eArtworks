...
<!-- Restore   -->
<div class="modal fade" id="restore_payment_<?php echo $payments['payment_id']; ?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form method="POST">
                <div class="modal-body text-center ">
                    <h4 class="text-danger">
                        Restore <?php echo  $payments['payment_ref_code'] ?>?
                    </h4>
                    <br>
                    <!-- Hide This -->
                    <input type="hidden" name="payment_id" value="<?php echo $payments['payment_id']; ?>">
                    <button type="button" class="text-center btn btn-success" data-bs-dismiss="modal">No</button>
                    <button type="submit" class="text-center btn btn-danger" name="Restore_Payment">Yes, Restore</button>
                </div>
            </form>
        </div>
    </div>
