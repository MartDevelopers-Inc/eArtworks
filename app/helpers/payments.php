...
if (isset($_POST['Update_Payment'])) {
    ...
    /* Persist */
    $sql = "UPDATE payment SET payment_mode ='{$payment_mode}', payment_amount = '{$payment_amount}'
...
if (isset($_POST['Delete_Payment'])) {
    ...
    /* Persist */
    $sql  = "UPDATE requests SET request_status = 'Unpaid' WHERE request_id = '{$request_id}'";
    $delete_sql = "DELETE FROM payment WHERE payment_id = '{$payment_id}'";


    /* Prepare */
    if (mysqli_query($mysqli, $sql) && mysqli_query($mysqli, $delete_sql)) {
