                        ...
                        <header class="page-title-bar">
                            <div class="d-flex flex-column flex-md-row">
                                ...
                                <div class="ml-auto">
                                    <!-- .dropdown -->
                                    <div class="dropdown">
                                        <button type="button" data-toggle="modal" data-target="#add_modal" class="btn btn-outline-primary"><span>Register New Admin</button>
                                    </div><!-- /.dropdown -->
                                </div>
                            </div>
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="admin_mobile" required class="form-control">
                                                </div>
                                                <div class="form-group col-md-6">
                                            ...
                                            <div class="text-right">
                                                <button name="Add_Admin_Account" class="btn btn-primary" type="submit">
                                                    Register Admin
                                                </button>
                                            </div>
                                            <br>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo $admin->admin_mobile; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo $admin->admin_email; ?>
                                                            </td>
                                                            <td>
                                                                <a data-toggle="modal" href="#update_<?php echo $admin->admin_id; ?>" class="badge  badge-pill badge-warning"><em class="fas fa-user-edit"></em> Edit</a>
                                                                <a data-toggle="modal" href="#delete_<?php echo $admin->admin_id; ?>" class="badge  badge-pill badge-danger"><em class="fas fa-trash"></em> Delete</a>
                                                            </td>
                                                        </tr>
                                                        <!-- Update Modal -->
                                                        <div class="modal fade" id="update_<?php echo $admin->admin_id; ?>">
                                                            <div class="modal-dialog modal-dialog-centered  modal-lg">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <form method="POST">
                                                                        <div class="modal-body text-center ">
                                                                            <h4 class="text-danger">
                                                                                Delete <?php echo  $admin->admin_name; ?> Account?
                                                                            </h4>
                                                                            <br>
                                                                            <!-- Hide This -->
                                                                            <input type="hidden" name="admin_id" value="<?php echo $admin->admin_id; ?>">
                                                                            <button type="button" class="text-center btn btn-outline-primary" data-dismiss="modal"> No</button>
                                                                            <button type="submit" class="text-center btn btn-outline-danger" name="Delete_Administrator"> Yes Delete</button>
                                                                            <hr>
                                                                        </div>
                                                                    </form>
                                                                </div>
