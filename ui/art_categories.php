                            ...
                            <div class="d-flex flex-column flex-md-row">
                                <p class="lead">
                                    <span class="font-weight-bold">
                                        Art / Painting Categories
                                    </span>
                                </p>
                                <div class="ml-auto">
                                    <!-- .dropdown -->
                                    <div class="dropdown">
                                        <button type="button" data-toggle="modal" data-target="#add_modal" class="btn btn-outline-primary"><span>Register New Category</button>
                                    </div><!-- /.dropdown -->
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered  modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Register New Category - Fill All Required Fields </h4>
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <input type="text" name="category_reg" value="<?php echo $a . $b; ?>" required class="form-control">
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label>Details</label>
                                                    <textarea type="text" name="category_desc" rows="3" required class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <hr>
                                            ...
                                            <table class="table table-bordered text-truncate" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td>
                                                                <?php echo $category->category_reg; ?>
                                                            </td>
                                                            <td>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form method="post" enctype="multipart/form-data">
                                                                            <div class="form-row">
                                                                                ...
                                                                                <div class="form-group col-md-4">
                                                                                    <label>Category Ref</label>
                                                                                    <input type="text" name="category_reg" value="<?php echo $category->category_reg; ?>" required class="form-control">
                                                                                </div>
                                                                                <div class="form-group col-md-12">
                                                                                    <label>Details</label>
                                                                                    <textarea type="text" name="category_desc" rows="3" required class="form-control"><?php echo $category->category_desc; ?></textarea>
                                                                                </div>
                                                                            </div>
                                                                            <hr>
                                                                            <div class="text-right">
                                                                    ...
                                                                    <form method="POST">
                                                                        <div class="modal-body text-center ">
                                                                            <h4 class="text-danger">
                                                                                Delete <?php echo  $category->category_name; ?>?
                                                                            </h4>
                                                                            <br>
                                                                            <!-- Hide This -->
                                                                            <input type="hidden" name="category_id" value="<?php echo $category->category_id; ?>">
                                                                            <button type="button" class="text-center btn btn-outline-primary" data-dismiss="modal"> No</button>
                                                                            <button type="submit" class="text-center btn btn-outline-danger" name="Delete_Category"> Yes Delete</button>
                                                                            <hr>
                                                                        </div>
                                                                    </form>
                                                                </div>
