                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a data-toggle="modal" href="#update_<?php echo $purchases->payment_id; ?>" class="badge  badge-pill badge-warning"><em class="fas fa-edit"></em> Edit</a>
                                                                <a data-toggle="modal" href="#delete_<?php echo $purchases->payment_id; ?>" class="badge  badge-pill badge-danger"><em class="fas fa-trash"></em> Delete</a>
                                                            </td>
                                                        </tr>

                                                        <!-- Update Modal -->
                                                        <div class="modal fade" id="update_<?php echo $purchases->payment_id; ?>">
                                                                            ...
                                                                            <div class="form-row">
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <select type="text" name="payment_mode" required class="form-control">
                                                                                        <option><?php echo $purchases->payment_mode; ?></option>
                                                                                ...
                                                                                <div class="form-group col-md-6">
                                                                                    ...
                                                                                    <input type="hidden" name="payment_id" value="<?php echo $purchases->payment_id; ?>" required class="form-control">
                                                                                    <input type="text" name="payment_amount" value="<?php echo $purchases->payment_amount; ?>" required class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <hr>
                                                                            <div class="text-right">
                                                                                <button name="Update_Payment" class="btn btn-primary" type="submit">
                                                                                    Update Payment
                                                                                </button>
                                                                            </div>
                                                                            <br>
                                                        ...
                                                        <!-- Delete Modal -->
                                                        <div class="modal fade" id="delete_<?php echo $purchases->payment_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    ...
                                                                    <form method="POST">
                                                                        <div class="modal-body text-center ">
                                                                            <h4 class="text-danger">
                                                                                Delete <?php echo  $purchases->payment_trans_code; ?> Record?
                                                                            </h4>
                                                                            <br>
                                                                            <!-- Hide This -->
                                                                            <input type="hidden" name="request_id" value="<?php echo $purchases->request_id; ?>">
                                                                            <input type="hidden" name="payment_id" value="<?php echo $purchases->payment_id; ?>">
                                                                            <button type="button" class="text-center btn btn-outline-primary" data-dismiss="modal"> No</button>
                                                                            <button type="submit" class="text-center btn btn-outline-danger" name="Delete_Payment"> Yes Delete</button>
                                                                            <hr>
                                                                        </div>
                                                                    </form>
                                                                </div>
