...
<body class="track_order_page">
    ...
    $order_payable_amount = mysqli_real_escape_string($mysqli, $_GET['amount']);
                        ...
                        <div class="col-12">
                            <div class="row ec_breadcrumb_inner">
                                <div class="col-md-6 col-sm-12">
                                    <h2 class="ec-breadcrumb-title">Pay Order <?php echo $order_code; ?></h2>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <ul class="ec-breadcrumb-list">
                                        ...
                                        <li class="ec-breadcrumb-item"><a href="landing_track_order_details?view=<?php echo $order_code; ?>?">Track</a></li>
                                        <li class="ec-breadcrumb-item active">Pay Order Via MPESA</li>
                                    </ul>
                    ...
                    <div class="ec-trackorder-content col-md-12">
                        <div class="ec-trackorder-inner">
                            <div class="ec-trackorder-top">
                                <h2 class="ec-order-id">Pay Order #<?php echo $orders['order_code']; ?> Via MPESA</h2>
                                <div class="ec-order-detail">
                                    <div>
                                        <strong>Lipa Na MPESA Payment Instructions</strong> <br><br>
                                        <strong>1. Go to MPESA</strong><br>
                                        <strong>2. Select LIPA NA MPESA</strong><br>
                                        <strong>3. Select Buy Goods and Services</strong><br>
                                        <strong>4. Enter Till No: </strong><br>
                                        <strong>5. Amount: Ksh <?php echo number_format($order_payable_amount, 2); ?></strong><br>
                                        <strong>6. Click Pay Now</strong><br>
                                    </div>
                                    <hr>
                                </div>
                            </div>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td data-label="Total" class="ec-cart-pro-subtotal">
                                                            <span class="tbl-btn">
                                                                <button class="btn btn-lg btn-primary" data-bs-toggle="modal" data-bs-target="#confirm_payment_<?php echo $order_code; ?>">Pay Now</button>
                                                            </span>
                                                        </td>
                                                    </tr>
                                                <?php }
                                                /* Include Payments Modal */
                                                include('../app/modals/confirm_payment_modal.php');
                                            } else { ?>
                                                <tr>
