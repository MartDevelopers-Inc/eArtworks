            ...
            <div class="ec-content-wrapper">
                <div class="content">
                    <div class="breadcrumb-wrapper breadcrumb-contacts">
                        <div>
                            <h1>Deleted Customers Accounts</h1>
                            <p class="breadcrumbs">
                                        ...
                                        <table id="responsive-data-table" class="table">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                            ...
                                                            <td>
                                                                <div class="btn-group mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" data-bs-toggle="modal" href="#restore_staff_<?php echo $staffs['user_id']; ?>">Restore</a>
                                                        ...
                                                        <!-- Delete Staff Modal -->
                                                        <?php include('../app/modals/users_recycle_bin.php'); ?>
                                                        <!-- End Modal -->
                                                <?php }
                                                } ?>
                                            </tbody>
