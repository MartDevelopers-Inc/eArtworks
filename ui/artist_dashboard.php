                                ...
                                <div class="metric-row">
                                    <div class="col-lg-12">
                                        <div class="metric-row metric-flush">
                                            ...
                                            <div class="col">
                                                <!-- .metric -->
                                                <a href="artist_designs_and_arts" class="metric metric-bordered align-items-center">
                                            ...
                                            <div class="col">
                                                <!-- .metric -->
                                                <a href="artist_payments" class="metric metric-bordered align-items-center">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-bordered text-truncate" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    WHERE ar.artist_id = '{$login_artist_id}'";
