                    ...
                    <div class="breadcrumb-wrapper breadcrumb-contacts">
                        <div>
                            ...
                            <p class="breadcrumbs">
                                ...
                                <span><i class="mdi mdi-chevron-right"></i></span><a href="backoffice_manage_orders">Recycle Bin</a>
                                        ...
                                        <table id="responsive-data-table" class="table">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                            ...
                                                            <td>
                                                                <div class="btn-group mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" data-bs-toggle="modal" href="#restore_order_<?php echo $orders['order_code']; ?>">Restore</a>
                                                        ...
                                                        <!-- Delete Staff Modal -->
                                                        <?php include('../app/modals/order_recycle_bin.php'); ?>
                                                        <!-- End Modal -->
                                                <?php }
                                                } ?>
                                            </tbody>
