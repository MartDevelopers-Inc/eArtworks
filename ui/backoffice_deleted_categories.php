            ...
            <div class="ec-content-wrapper">
                <div class="content">
                    <div class="breadcrumb-wrapper breadcrumb-contacts">
                        <div>
                            <h1>Deleted Product Categories</h1>
                            <p class="breadcrumbs">
                                    ...
                                    <div class="table-responsive">
                                        <table id="responsive-data-table" class="table">
                                            ...
                                            <tbody>
                                                            ...
                                                            <td>
                                                                <div class="btn-group mb-1">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item" data-bs-toggle="modal" href="#restore_category_<?php echo $categories['category_id']; ?>">Restore</a>
                                                ...
                                                <?php
                                                        include('../app/modals/categories_recycle_bin.php');
                                                    }
                                                } ?>
                                            </tbody>
                                        </table>
