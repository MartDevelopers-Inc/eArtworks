                    ...
                    <div class="page-inner">
                        ...
                        <header class="page-title-bar">
                            <div class="d-flex flex-column flex-md-row">
                                <p class="lead">
                                    <span class="font-weight-bold">Hi there.</span> <span class="d-block text-muted">Here is the glance of whats happening today.</span>
                                </p>
                                <div class="ml-auto">
                                    <!-- .dropdown -->
                                    <div class="dropdown">
                                ...
                                <div class="metric-row">
                                    <div class="col-lg-12">
                                        <div class="metric-row metric-flush">
                                            ...
                                            <div class="col">
                                                <!-- .metric -->
                                                <a href="user_purchases" class="metric metric-bordered align-items-center">
                                                    <h2 class="metric-label"> Un Paid Artworks & Paitings Purchases </h2>
                                                    <p class="metric-value h3">
                                                        <sub><i class="fas fa-paint-brush"></i></sub> <span class="value"><?php echo $unpaid; ?></span>
                                                    </p>
                                                </a> <!-- /.metric -->
                                            </div><!-- /metric column -->
                                            <div class="col">
                                                ...
                                                <a href="user_purchases" class="metric metric-bordered align-items-center">
                                                    ...
                                                    <p class="metric-value h3">
                                                        <sub><i class="fas fa-money-bill"></i></sub> <span class="value"><?php echo $purchases; ?></span>
                                                    </p>
                                                </a> <!-- /.metric -->
                                            </div><!-- /metric column -->
                                            <div class="col">
                                                <!-- .metric -->
                                                <a href="user_payments" class="metric metric-bordered align-items-center">
                                                    <h2 class="metric-label"> Expenditures </h2>
                                                    <p class="metric-value h3">
