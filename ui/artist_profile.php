...
<body>
    ...
    <div class="app">
        ...
        $ret = "SELECT * FROM artist a
        INNER JOIN login l ON a.artist_id = l.login_artist_id
                        ...
                        <header class="page-cover">
                            <div class="text-center">
                                <a href="" class="user-avatar user-avatar-xl">
                                    <img src="../assets/upload/artists/<?php echo $artist->artist_image; ?>" alt=""></a>
                                <h2 class="h4 mt-2 mb-0"> <?php echo $artist->artist_name; ?> </h2>
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item active">
                                            <a href="artist_dashboard"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>Back Home</a>
                                        </li>
                                    </ol>
                                </nav>
                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="hidden" name="login_artist_id" value="<?php echo $artist->artist_id; ?>" required class="form-control">
                                                            <input type="text" value="<?php echo $artist->login_username; ?>" name="login_username" required class="form-control">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                    ...
                                                    <br>
                                                    <div class="text-right">
                                                        <button name="Update_Artist_Password" class="btn btn-primary" type="submit">
